...
class ArchitectureTest {
    ...
    void la_presentacion_no_conoce_la_persistencia() {
        ArchRule regla = noClasses()
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage("co.sastra..persistence..", "co.sastra..client..")
    ...
    void la_infraestructura_no_conoce_los_controladores() {
        ArchRule regla = noClasses()
                .should()
                .dependOnClassesThat()
                .resideInAPackage("co.sastra..rest..")
    ...
    void un_caso_de_uso_no_toca_la_persistencia() {
        ArchRule regla = noClasses()
                .that()
                .resideInAPackage("co.sastra..usecase..")
                .should()
                .dependOnClassesThat()
                .resideInAPackage("co.sastra..persistence..")
    ...
    private static JavaClasses todasLasClasesIncluidasLasPruebas() {
        return new ClassFileImporter().importPackages("co.sastra");
    }
}
