...
import co.sendik.shared.file.GcsPublicFileStore;
import co.sendik.shared.file.GcsRestrictedFileStore;
...
@SpringBootTest(
        properties = {
            "sendik.storage.provider=gcs",
            "sendik.storage.public-bucket=cubo-publico-de-prueba",
            "sendik.storage.restricted-bucket=cubo-reservado-de-prueba"
        })
...
class StorageProviderWiringTest {
    ...
    void deberia_componer_la_direccion_publica_sobre_la_base_configurada() {
        assertThat(publico.direccionDe(new co.sendik.shared.file.FileKey("avatares/abc.png")))
