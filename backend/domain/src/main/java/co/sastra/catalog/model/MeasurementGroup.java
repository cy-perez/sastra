...
import static co.sastra.catalog.model.MeasurementKind.CHEST;
import static co.sastra.catalog.model.MeasurementKind.DEPTH;
import static co.sastra.catalog.model.MeasurementKind.HEIGHT;
import static co.sastra.catalog.model.MeasurementKind.HIP;
import static co.sastra.catalog.model.MeasurementKind.INSOLE;
import static co.sastra.catalog.model.MeasurementKind.LENGTH;
import static co.sastra.catalog.model.MeasurementKind.RISE;
import static co.sastra.catalog.model.MeasurementKind.SHOULDERS;
import static co.sastra.catalog.model.MeasurementKind.SLEEVE;
import static co.sastra.catalog.model.MeasurementKind.WAIST;
import static co.sastra.catalog.model.MeasurementKind.WIDTH;
