...
final class VerificationMailTexts {
    ...
    static String asuntoDeAprobada(UserLocale idioma) {
        return espanol(idioma) ? "Ya eres vendedor verificado en Sastra" : "You are a verified seller on Sastra";
    }
