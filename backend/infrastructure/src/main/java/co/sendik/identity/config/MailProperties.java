 ...
 *     solo la necesita {@link co.sendik.identity.client.ResendMailSender}, y con
 *     {@code sendik.mail.provider=console} —lo que usa el perfil local— no se
 ...
 *     Se concatena a sendik.app.base-url; no se quema porque la ruta publica
 ...
 */
@Validated
@ConfigurationProperties(prefix = "sendik.mail")
